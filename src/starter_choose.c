...
#define GRASS_STARTER (IS_FRLG ? SPECIES_TURTWIG  : SPECIES_TREECKO)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHIMCHAR  : SPECIES_TORCHIC)
#define WATER_STARTER (IS_FRLG ? SPECIES_PIPLUP    : SPECIES_MUDKIP )
